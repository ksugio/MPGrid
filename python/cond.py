...
if __name__ == "__main__":
    ...
    findv = 1.0e-13
    lam_fe = 67
    g = MPGrid.new(nx, ny, 1, 1)
    g.element = (elm, elm, elm)
    g.bound = (0, 0, 0, 0, 0, 0)
    g.set_rhoc(7.87*460, 0) # Fe
    g.set_inter_coef1(0, lam_fe, 0, 0)
    g.fill_update(0, (0, 0, 0), (0, ny-1, 0))
    g.fill_update(0, (nx-1, 0, 0), (nx-1, ny-1, 0))
    g.fill_val(300, (0, 0, 0), (nx-1, ny-1, 1))
    g.fill_val(vlr+300, (0, 0, 0), (0, ny-1, 0))
    while 1:
        dv = g.solve(dt, 10000)
